...
/**
 * Ejemplo donde se convierte un array en una lista sin usar interadores.
 * @author Salvador Romero Villegas
 */
public class E17EjemploIteradores3 {
    ...
    public static void main(String[] args)
    {
        ...
        List<Rectangulo> lista=Arrays.<Rectangulo>asList(rectangulos);
